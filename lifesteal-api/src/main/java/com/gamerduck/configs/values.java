...
public class values {
	...
	public static Boolean MYSQL_ENABLED, MYSQL_AUTORECONNECT, DEFAULT_LOSE_HEARTS_ON_NON_PLAYER_DEATH, TAB_ENABLED, HEARTCANASTER_ENABLED, 
						  SHOULD_DAMAGE_SCALE_WITH_HEALTH, SHOULD_KEEP_LAST_PLAYER_AS_DAMAGER, SHOULD_WITHDRAW_COMMAND_EXIST;
	public static String MYSQL_HOST, MYSQL_DATABASE, MYSQL_USERNAME, MYSQL_PASSWORD, DEFAULT_CONVERT_FROM, MESSAGES_NOPERMISSIONS, MESSAGES_PLAYER_NOT_ONLINE, 
						 ...
						 HEARTCANASTER_ITEM_DISPLAYNAME, HEARTCANASTER_ITEM_MATERIAL, MESSAGES_LEFT_WITH_ONE_HEART, MESSAGES_HEARTS_WITHDRAWN,
	...
	public static void load(FileConfiguration cf) {
		...
		HOW_LONG_SHOULD_PLAYER_BE_LAST_DAMAGER = getInteger("Defaults.HowLongShouldPlayerBeLastDamager");
		SHOULD_KEEP_LAST_PLAYER_AS_DAMAGER = getBoolean("Defaults.ShouldKeepLastPlayerAsDamager");
		SHOULD_DAMAGE_SCALE_WITH_HEALTH = getBoolean("Defaults.ShouldDamageScaleWithHealth");
		SHOULD_WITHDRAW_COMMAND_EXIST = getBoolean("Defaults.ShouldWithDrawCommandExist");
		...
		MESSAGES_LEFT_WITH_ONE_HEART = getString("Messages.CantBeLeftWithLessThanOneHeart");
		MESSAGES_HEARTS_WITHDRAWN = getString("Messages.HeartsWithdrawn");
		MESSAGES_HAS_TO_BE_WHOLE_NUMBER = getString("Messages.HasToBeWholeNumber");
